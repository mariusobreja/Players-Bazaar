  ...
  return (
    <main>
      ...
      <Wrapper className='page section section-center'>
        <img src={aboutImg} alt='epic fail' />
        <article>
          <div className='title'>
            <h2>our story</h2>
          ...
          <p>
            ...
            player before making the decission to buy him. You have full control
            of the informations received about a player, instead of the agents
